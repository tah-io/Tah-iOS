...
- (void)prepareForSegue:(UIStoryboardSegue *)segue sender:(id)sender
{
    ...
    {
        TAHIOViewController *detailViewController = [segue destinationViewController];
    ...
    {
        TAHPWMViewController *detailViewController = [segue destinationViewController];
    ...
    {
        AnalogViewController *detailViewController = [segue destinationViewController];
